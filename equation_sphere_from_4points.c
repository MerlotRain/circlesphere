...
#define free_matrix4x4(x)                                                      \
  ...
  memset_value_to_matrix4x4(mm11, A.x, A.y, A.z, 1.0, B.x, B.y, B.z, 1.0, C.x,
                            C.y, C.z, 1.0, D.x, D.y, D.z, 1.0);
  memset_value_to_matrix4x4(mm12, asqrt, A.y, A.z, 1.0, bsqrt, B.y, B.z, 1.0,
                            csqrt, C.y, C.z, 1.0, dsqrt, D.y, D.z, 1.0);
  memset_value_to_matrix4x4(mm13, asqrt, A.x, A.z, 1.0, bsqrt, B.x, B.z, 1.0,
                            csqrt, C.x, C.z, 1.0, dsqrt, D.x, D.z, 1.0);
  memset_value_to_matrix4x4(mm14, asqrt, A.x, A.y, 1.0, bsqrt, B.x, B.y, 1.0,
                            csqrt, C.x, C.y, 1.0, dsqrt, D.x, D.y, 1.0);
  memset_value_to_matrix4x4(mm15, asqrt, A.x, A.y, A.z, bsqrt, B.x, B.y, B.z,
                            csqrt, C.x, C.y, C.z, dsqrt, D.x, D.y, D.z);
...
int main(int argc, char **argv) {
  ...
  printf("sphere center is: (%f,%f,%f), radius is: %f", sphere.center.x,
